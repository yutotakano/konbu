<?php
/**
 * Modified version of Siteguard Really Simple Captcha to run with Konbu.
 * Modifications:
 * - removed SiteGuard functions such as trailingslashit and sanitizefilename.
 * - removed referneces to internal wp functions like wp_mkdir_p
 * - removed the generation of answer file
 * - make the name of the generated image be the answer
 * - removed calls to $this->cleanup()
 * 
 */
...
class SiteGuardReallySimpleCaptcha {
